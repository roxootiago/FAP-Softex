...
class Queue {
  ...
  console.log(minhaFila.size())

  console.log(minhaFila.enqueue(40))
  console.log(minhaFila.enqueue(60))
  console.log(`tamanho da minha fila: ${minhaFila.size()}`)
  console.log(minhaFila.front()); // Saída: 20
  console.log(minhaFila.isEmpty())
=======
class Queue {
    constructor() {
      this.items = [];
